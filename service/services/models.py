...
from services.receivers import delete_cache_totlal_sum
...
class Plan(models.Model): 
    ...
    plan = models.CharField(choices=PLAN_TYPES, max_length=10)
...
post_delete.connect(delete_cache_totlal_sum, sender=Subscription)
